package br.com.appmodelo.model.config;
...
@Configuration
@PropertySource(value = {"classpath:db.properties", "classpath:messages.properties"})
@EnableTransactionManagement
@ComponentScans(value = {@ComponentScan("br.com.framework")})
public class AppConfig {
  ...
  public LocalSessionFactoryBean getSessionFactory() {
    ...
    factoryBean.setPackagesToScan("br.com.appmodelo.model.entity");
